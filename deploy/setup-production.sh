...
echo "  4. Copy deploy/php-playnova-uploads.ini to /etc/php.d/99-playnova-uploads.ini and restart php-fpm"
echo "  5. Set SENTRY_LARAVEL_DSN and NUXT_PUBLIC_SENTRY_DSN"
