    ...
    <div class="md:col-span-2 space-y-6">
      <div class="bg-dark-800 border border-dark-600 rounded-xl p-6">
        ...
        <form class="space-y-3" @submit.prevent="submit">
          ...
          <PasswordInput v-model="form.password" placeholder="رمز عبور جدید (اختیاری)" class="w-full bg-dark-700 border border-dark-600 rounded px-3 py-2 outline-none focus:border-secondary text-white" autocomplete="new-password" />
          <PasswordInput v-model="form.password_confirmation" placeholder="تکرار رمز عبور جدید" class="w-full bg-dark-700 border border-dark-600 rounded px-3 py-2 outline-none focus:border-secondary text-white" autocomplete="new-password" />
